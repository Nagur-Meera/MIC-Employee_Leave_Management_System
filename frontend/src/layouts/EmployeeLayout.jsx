...
const EmployeeLayout = () => {
  ...
  const navigation = [
    ...
    { name: 'Apply Leave', href: '/employee/apply-leave', icon: Plus },
          ...
          <div className="border-t border-gray-200 p-4">
            <div className="flex items-center mb-3">
              ...
              <div className="ml-3">
                ...
                <p className="text-xs" style={{ color: 'var(--mic-logo-green)' }}>Employee - {user?.department}</p>
              </div>
            </div>
            <button
              onClick={logout}
          ...
          <div className="flex h-20 items-center px-6 border-b border-gray-200">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm" style={{ color: 'var(--mic-logo-green)' }}>
                  Employee Portal
                </p>
              </div>
            </div>
