          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
            ...
            <div>
              ...
              >
                ...
                <option value="hodApproved">HOD Approved</option>
                  ...
                  <tr key={application._id} className="border-b border-gray-100 hover:bg-gray-50">
                    ...
                    <td className="py-3 px-4">
                      <div className="flex space-x-2">
                        ...
                        {(application.status === 'pending' || application.status === 'hodApproved') && (
                          <>
                            <button
                              onClick={() => handleApprove(application._id)}
                              className="btn btn-sm btn-success"
                              disabled={application.status === 'pending'}
                              title={application.status === 'pending' ? "Requires HOD approval first" : ""}
                            >
                              Approve
                            </button>
                            <button
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex justify-end space-x-3 pt-4">
              ...
              {(selectedApplication.status === 'pending' || selectedApplication.status === 'hodApproved') && (
                <>
                  <button
                    onClick={() => handleApprove(selectedApplication._id)}
                    className="btn btn-success"
                    disabled={selectedApplication.status === 'pending'}
                    title={selectedApplication.status === 'pending' ? "Requires HOD approval first" : ""}
                  >
                    Approve
                  </button>
                  <button
