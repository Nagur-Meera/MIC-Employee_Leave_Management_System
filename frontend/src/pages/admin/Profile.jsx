        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
              <div style={{ background: 'linear-gradient(135deg, var(--mic-bright-red), var(--mic-red-dark))' }} className="h-24"></div>
              <div className="relative px-6 pb-6">
                <div className="flex flex-col items-center -mt-12">
                  <div style={{ background: 'linear-gradient(135deg, var(--mic-bright-red), var(--mic-red-dark))' }} className="w-24 h-24 rounded-2xl flex items-center justify-center shadow-xl border-4 border-white">
                  ...
                  <div className="w-full mt-6 space-y-4">
                    <div className="bg-gray-50 rounded-xl p-4">
                      <div className="flex items-center gap-3">
                        <div style={{ backgroundColor: 'rgba(211, 47, 47, 0.1)' }} className="w-10 h-10 rounded-lg flex items-center justify-center">
                          <svg style={{ color: 'var(--mic-bright-red)' }} className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="bg-gray-50 rounded-xl p-4">
                      <div className="flex items-center gap-3">
                        <div style={{ backgroundColor: 'rgba(0, 128, 0, 0.1)' }} className="w-10 h-10 rounded-lg flex items-center justify-center">
                          <svg style={{ color: 'var(--mic-logo-green)' }} className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {editMode ? (
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="space-y-2">
                        <label className="block text-sm font-semibold text-gray-700">Designation</label>
                        <div className="text-gray-900 font-medium">{user.designation}</div>
                      </div>
                      <div className="space-y-2">
                        <label className="block text-sm font-semibold text-gray-700">Qualification</label>
                        <div className="text-gray-900 font-medium">{user.qualification}</div>
                      </div>
                      <div className="space-y-2">
                    ...
                    {/* Address field removed for cleanup */}
                  </div>
                )}
              </div>
            </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-pink-500 focus:border-transparent transition-all duration-200 placeholder-gray-400"
