...
const EmployeeHistory = () => {
  ...
  const getStats = () => {
    ...
    const hodApproved = applications.filter(app => app.status === 'hodApproved').length;
    ...
    return { total, pending, hodApproved, approved, rejected, totalDays };
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4">
        ...
        <div className="card">
          <div className="card-content text-center">
            <div className="text-2xl font-bold text-info-600">{stats.hodApproved}</div>
            <div className="text-sm text-gray-600">HOD Approved</div>
          </div>
        </div>
        <div className="card">
          <div className="card-content text-center">
